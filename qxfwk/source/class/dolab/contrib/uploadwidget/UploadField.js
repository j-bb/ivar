 ...
 *
 */
qx.Class.define("dolab.contrib.uploadwidget.UploadField",
{
    ...
    construct : function(fieldName, label, icon) {
        ...
        this._textfield = new dolab.fwk.ui.form.TextField();
        this._textfield.setReadOnly(true);

        this._button = new dolab.contrib.uploadwidget.UploadButton(this.getFieldName(), label, icon);
